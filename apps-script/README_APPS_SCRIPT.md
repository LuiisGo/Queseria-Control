...
Apps Script valida `APP_SECRET`, usuario activo, rol, permisos, sucursal asignada, stock y precios oficiales. Las contraseñas usan SHA-256 con salt por limitaciones del entorno; para una versión más fuerte, migrar a un proveedor de auth o un backend con bcrypt/argon2.
