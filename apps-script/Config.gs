var CONFIG = {
  ...
  DEFAULT_ADMIN_PASSWORD_PROPERTY: "INITIAL_ADMIN_PASSWORD",
  CENTRAL_PASSWORD_PROPERTY: "INITIAL_CENTRAL_PASSWORD",
  AGROMARKET_PASSWORD_PROPERTY: "INITIAL_AGROMARKET_PASSWORD"
};
